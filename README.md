# GPS-tracer
The web-based application for real-time GPS tracking system to be depolyable in real world scenario.
...
This API provides self generated NMEA convertion method to INSS based format. 

* NMEA string method from Global Positioning System.
* INternation Space Station Strings.
* Https and Javascript web Terminology.
